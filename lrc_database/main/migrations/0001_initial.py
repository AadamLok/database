# Generated by Django 4.1.5 on 2023-03-12 13:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("late_datetime", models.DateTimeField(blank=True)),
            ],
            options={
                "ordering": ("start",),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "peers",
                    models.ManyToManyField(
                        blank=True, default=None, related_name="pm_staff_peers", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "person",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_of_switch",
                    models.DateField(
                        help_text="Date on which university is following some other days schedule.", unique=True
                    ),
                ),
                (
                    "day_to_follow",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "location",
                    models.CharField(help_text="The location where the class will occur, e.g. GSMN 64.", max_length=32),
                ),
                (
                    "class_day",
                    models.PositiveSmallIntegerField(
